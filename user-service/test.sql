...
create table user_type ( id integer auto_increment primary key, name varchar(255) );
...
create table certificate_state (id integer primary key auto_increment, name varchar(255));
...
create table sample_state (id integer primary key auto_increment, name varchar(255));

create table inspection_unit (id integer primary key auto_increment, name varchar(255));
